...
$sql ="SELECT UserID,Passwd FROM Users WHERE Passwd='$password' and UserID=$username";
$query1 = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));

$norows =sqlsrv_num_rows( $query1 );
if($norows > 0)
{
$con="update Users set Passwd = '$newpassword' where UserID = $username";
$query2 = sqlsrv_query($conn,$con,array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));
